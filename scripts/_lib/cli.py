"""scripts/_lib/cli.py — shared scaffolding for the `nebulith-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("nebulith-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/nebulith-foo`
...
VERSION = "0.1.0"  # bumped centrally; every nebulith-* CLI reports this
