...
// ── Key constants ──
export const KEYS = {
  THEME: 'nebulith-theme',
  TOGGLES: 'nebulith-toggles',
  ...
  MODELS_EXPANDED: 'nebulith-model-expanded',
  MODEL_ENDPOINTS: 'nebulith-model-endpoints',
  MODEL_SELECTED: 'nebulith-selected-model',
  SORT_ORDER: 'nebulith-sessions-sort',
  CHAT_SEARCH_SCOPE: 'nebulith-search-scope',
  INCOGNITO: 'nebulith-incognito',
  RAG_ACTIVE: 'nebulith-rag-active',
  MCP_ACTIVE: 'nebulith-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'nebulith-density'
};
