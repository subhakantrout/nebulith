...
const LS_KEY = 'nebulith-theme';
const CUSTOM_THEMES_KEY = 'nebulith-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Nebulith Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'nebulith_' + (obj.name || 'theme') + '.json';
      a.click();
