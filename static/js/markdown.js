...
function initMermaid() {
  if (!window.mermaid || window.__nebulithMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__nebulithMermaidReady = true;
}
window.nebulithInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'nebulith-thinking-expanded';
