...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('nebulith-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'nebulith-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'nebulith-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'nebulith-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'nebulith-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'nebulith-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'nebulith-notes-first-open-hint-v1';
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('nebulith-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'nebulith-note-draft-';
