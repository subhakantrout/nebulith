...
- [ ] I searched [open issues](https://github.com/SubhakantaRout/nebulith/issues) and [open PRs](https://github.com/SubhakantaRout/nebulith/pulls) — this is not a duplicate.
...
- [ ] **Style match**: the change uses Nebulith's existing visual language. Specifically:
