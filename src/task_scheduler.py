...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-Nebulith-Origin"] = "nebulith-ui"
            msg["X-Nebulith-Kind"] = "task"
            msg["X-Nebulith-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-Nebulith-Origin": "nebulith-ui",
                "X-Nebulith-Kind": "task",
                "X-Nebulith-Ref": str(task.id),
            },
        }
        if recipient:
