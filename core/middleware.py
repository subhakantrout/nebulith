...
INTERNAL_TOOL_TOKEN = os.environ.get("NEBULITH_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Nebulith-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Nebulith-Internal-Token), or
