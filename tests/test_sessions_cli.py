...
def _load_sessions_cli(monkeypatch):
    ...
    path = Path(__file__).resolve().parent.parent / "scripts" / "nebulith-sessions"
    loader = importlib.machinery.SourceFileLoader("nebulith_sessions_cli_under_test", str(path))
