...
def _load_dispatcher():
    path = Path(__file__).resolve().parent.parent / "scripts" / "nebulith"
    loader = importlib.machinery.SourceFileLoader("nebulith_dispatcher_under_test", str(path))
